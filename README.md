...
## Text Completion
One of the experiments we are interested in doing is to compare how GPT-2 compares with GPT-3 on the text ccompletion task.  So, we have prompted GPT-2 with a few sentence to see how it performs.  See the notebook for details.
